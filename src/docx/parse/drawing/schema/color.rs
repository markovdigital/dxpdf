...
pub enum StPresetColorVal {
    ...
    DkSlateGray, DkSlateGrey, DkTurquoise, DkViolet,
    ...
    LtBlue, LtCoral, LtCyan, LtGoldenrodYellow, LtGray, LtGreen, LtGrey, LtPink,
    LtSalmon, LtSeaGreen, LtSkyBlue, LtSlateGray, LtSlateGrey, LtSteelBlue, LtYellow,
    Magenta, Maroon,
...
mod tests {
    ...
    fn hue_transform_preserves_angle() {
        let c = parse(
            r#"<srgbClr val="FF0000"><hue val="3600000"/></srgbClr>"#,
        );
        match c {
